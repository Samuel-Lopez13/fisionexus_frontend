...
<template>
  <nav class="flex flex-col items-center w-16 h-screen space-y-8 bg-white border-r border-gray-300 telefono:hidden">
    <div class="flex flex-col items-center w-16 py-5 space-y-5">
      ...
      <router-link :to="{name:'Inicio'}" active-class="border-l-4 border-blue-600"
      ...
      <router-link :to="{name:'Pacientes'}" active-class="border-l-4 border-blue-600 text-blue-600"
      ...
      <router-link :to="{name:'Metricas'}" active-class="border-l-4 border-blue-600" data-tooltip-target="Metricas"
      ...
      <router-link :to="{name:'Ajustes'}" active-class="border-l-4 border-blue-600"
                   class="w-full p-1.5 text-gray-500 duration-100 hover:text-blue-600 flex justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
             stroke="currentColor" class="w-6 h-6">
          <path stroke-linecap="round" stroke-linejoin="round"
