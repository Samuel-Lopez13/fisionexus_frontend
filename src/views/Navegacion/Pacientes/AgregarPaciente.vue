  ...
  <div class="flex telefono:flex-col">
    ...
    <section class="desktop:w-9/12 laptop:w-9/12 tablet:w-full telefono:w-full">
      ...
      <div class="grid gap-6 mb-6 md:grid-cols-2">
        <div>
          <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Nombre(s) <span
        ...
        <div>
          <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Apellidos <span
            class="text-blue-600">*</span></label>
          <input type="text"
                 class="input-primary"
        ...
        <div>
          <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Sexo <span
            class="text-blue-600">*</span></label>
        ...
        <div>
          <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Ocupación<span
            class="text-blue-600">*</span></label>
          <input type="text"
                 class="input-primary"
                 placeholder="Abogado"
        ...
        <div>
          <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Teléfono<span
            class="text-blue-600">*</span></label>
          <input type="tel"
                 class="input-primary"
        ...
        <div>
          <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Institución <span
            class="text-blue-600">*</span></label>
          <input type="text"
                 class="input-primary"
                 placeholder="SEAFI"
      ...
      <div class="flex gap-6 telefono:flex-wrap">
        <div class="mb-6 basis-3/4 telefono:basis-full">
          <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Domicilio <span
            class="text-blue-600">*</span></label>
          <input type="text"
                 class="input-primary"
