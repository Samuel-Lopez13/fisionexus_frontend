...
<template>
    <div v-if="spinner" role="status" class="w-full flex items-center flex-col gap-2">
    ...
    <div v-else class="flex telefono:flex-col">
        <section class="mr-3">
