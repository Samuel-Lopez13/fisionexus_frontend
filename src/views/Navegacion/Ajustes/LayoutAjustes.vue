...
import SideBar from '@/components/usuario/SideBar.vue'
    ...
    <main class="flex">
        ...
        <div class="flex telefono:flex-col w-full">
            ...
            <section class="px-4 w-5/12 telefono:w-full flex flex-col gap-3">
                <div>
                    <header>
                        <h1 class="text-principal text-center font-Prompt font-medium text-2xl mb-2 telefono:mt-4">Datos del usuario</h1>
                    </header>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        />
                        <button type="button" @click="verContrasena"
