  ...
  <div class="max-w-sm w-full bg-white rounded border shadow p-4">
    ...
    <div class="flex justify-between telefono:flex-col telefono:items-center">
      <div>
        ...
        <p class="text-base font-normal text-gray-500 telefono:hidden">Pacientes agregados esta
          semana</p>
      </div>
      <div
      ...
      <div class="flex justify-between items-center telefono:flex-col mt-2">
        ...
        <div id="lastDaysdropdown"
          ...
          <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
            <li>
              <a href="#"
                 class="block px-4 py-2 hover:bg-gray-100">Ayer</a>
            </li>
            <li>
              <a href="#" class="block px-4 py-2 hover:bg-gray-100">Hoy</a>
            </li>
            <li>
              <a href="#" class="block px-4 py-2 hover:bg-gray-100">Esta
                semana</a>
            </li>
            <li>
              <a href="#" class="block px-4 py-2 hover:bg-gray-100">Este
                mes</a>
            </li>
            <li>
              <a href="#" class="block px-4 py-2 hover:bg-gray-100">Ultimos
                3 meses</a>
            </li>
          </ul>
        </div>
