...
<template>
  <div class="max-w-sm w-full tablet:w-[300px] laptop:w-[300px] bg-white rounded-lg rounded border shadow dark:bg-gray-800 p-6">
    <div class="flex justify-between items-start w-full">
      <div class="flex-col items-center">
        <div class="flex items-center mb-1">
          <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Estados de las citas</h5>
