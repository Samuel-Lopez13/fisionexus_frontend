...
const obtenerPaginas = async () => {
   ...
   paginas.value = respuesta.numeroPaginas
}
      ...
      <table class="w-full text-sm text-left rtl:text-right text-gray-500">
         ...
         <tr class="hover:bg-gray-50 hover:text-blue-500 border-b" v-for="paciente in pacientes" :key="paciente.id">
            ...
            <td class="py-3 telefono:p-4 flex gap-2">
               ...
               <svg @click="irExpediente(paciente.pacienteId)" class="hover:stroke-blue-500 cursor-pointer"
                    stroke="#758CA3" width="28px"
                    viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="1" y="1" width="38" height="38" rx="19" stroke-width="2" />
   ...
   <div class="flex justify-between relative">
      <button class="relative flex items-center text-gray-700 button-with-hover group">
         <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="SVGRepo_iconCarrier">
               <path class="group-hover:stroke-blue-600" d="M6 12H18M6 12L11 7M6 12L11 17" stroke="currentColor"
                     stroke-width="0.6"
      ...
      <button class="relative flex items-center text-gray-700 button-with-hover group">
         ...
         <svg width="24px" height="24px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
               <path class="group-hover:stroke-blue-600" d="M6 12H18M18 12L13 7M18 12L13 17" stroke="currentColor"
                     stroke-width="0.6"
                     stroke-linecap="round" stroke-linejoin="round"></path>
            </g>
         </svg>
