  ...
  <div class="relative overflow-x-auto">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
      ...
      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        ...
        <th scope="row" class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">1</th>

        <td class="py-4">Miguel Ángel Hernández Pat</td>
        <td class="py-4">33 años</td>
        <td class="py-4">Hombre</td>
        <td class="py-4">9812244054</td>
        ...
        <td class="py-4 flex gap-3">
          ...
          <svg class="hover:stroke-blue-500 cursor-pointer" stroke="#758CA3" width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="1" y="1" width="38" height="38" rx="19" stroke-width="2" />
            <path
              d="M25.5 18.5L28.5 15.5L24.5 11.5L21.5 14.5M25.5 18.5L15.5 28.5H11.5V24.5L21.5 14.5M25.5 18.5L21.5 14.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
          <svg class="hover:stroke-blue-500 cursor-pointer" stroke="#758CA3" width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="1" y="1" width="38" height="38" rx="19" stroke-width="2"/>
          ...
          <svg class="hover:stroke-red-500 cursor-pointer" stroke="#758CA3" width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M22.125 18.9375V25.3125" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round" />
            <path d="M11.5 14.6875H28.5" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round" />
            <path
